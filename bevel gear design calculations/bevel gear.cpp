// bevel gear.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	double alf = 20, m = 0, b = 0, u = 0, Dp = 0, Dg = 0, Dpm = 0, Dgm = 0, Zp, Zg, Zfp, Zfg, DLTp = 0, DLTg = 0, L = 0, P = 0, T = 0, w = 0, V = 0, Pt = 0,Frp,Frg,Fap,Fag, Pd = 0, Pen = 0, Pw = 0, Kyp = 0, Kyg = 0, Ks = 0, Kv = 0, Sp, Sg, Syp, Sup, Syg, Sug, Senp, Seng,BHN=0, Kd, K = 0.111, e,ep,er, Ep, Eg, Kw, Kn, MS;
    ...
    do {
        ...
        do {
            cout << "        module  (mm/tooth)  =  "; cin >> m; cout << endl;
            string y, x = "4";
            double r;
            r = stod(module[0][0]);
            if (m == r)
        ...
        if ((b / L) < (1 / 4))
            cout << " warning :   b/L < 1/4  that is not good you can increase b or m , or decrease Dp \n\n";
        if ((b / L) > (0.33333333))
            cout << " warning :   b/L > 1/3  that is not good you can decrease b or m , or increase Dp \n\n";

        DLTp = atan(1 / u);
        DLTg = (3.14159 / 2) - DLTp;
        Dpm = Dp - (b * sin(DLTp));
        Dgm = Dg - (b * sin(DLTg));
        Pt = (P * 60 * 2E6) / (w * Dpm * 2 * 3.14159);
        Frp = Pt * tan(alf * ((2 * 3.14159) / 180)) * cos(DLTp);
        Fag = Frp;
        Fap = Pt * tan(alf * ((2 * 3.14159) / 180)) * sin(DLTp);
        Frg = Fap;
        ...
        cout << "  Pt = " << Pt  << " (N) " << endl;
        cout << "Frp = Fag =" << Frp  << " (N) " << endl;
        cout << "Fap = Frg =" << Fap  << " (N) " << endl;
        cout << " Kyp = " << Kyp  << endl;
        cout << "  Ks = " << Ks   << endl;
        cout << "  Kv = " << Kv   << endl;
        cout << "   V = " << V    << " (m/s) " << endl;
        ...
        if (c != "6")
        {
            ...
            Pd = Pt + ((Kd * b) + Pt) / (1 + (0.15 / V) * sqrt((Kd * b) + Pt));
            cout << "  Pd =" << Pd << "N \n\n";
